...
import {CredentialRole, DidAuthConfig, Identity, Party} from '@sphereon/ssi-sdk.data-store';
...
import {OID4VP, OpSession} from '@sphereon/ssi-sdk.siopv2-oid4vp-op-auth';
    ...
    },
    {
      actions: {
        logDeclineShare: async (context, event) => {
          console.log(`SELECTED CREDENTIALS: ${JSON.stringify(context.selectedCredentials)}`);

          context.selectedCredentials.forEach(credential =>
            store.dispatch<any>(
