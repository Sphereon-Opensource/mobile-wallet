  ...
  return (
    <ScreenContainer footer={footer} footerStyle={{gap: 12}}>
      ...
      <ContentContainer>
        ...
        <ProviderContainer
          accessible
          accessibilityLabel="Name: Bundesdruckerei GmbH, role: ISSUER, url: https://demo.pid-issuer.bundesdruckerei.de/c">
        ...
        <ProviderCardRow>
          ...
          <ProviderDescription
            accessible
            // sorry had to
            accessibilityLabel="Card: Ausweis e ID, Issuer: German Bundesdruckerei">
