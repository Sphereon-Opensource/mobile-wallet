...
const {MyModule} = NativeModules; // FIXME on iOS MyModule is not defined, I also don't see a .h / .m file with MyModule in it. The functionality relalted to closing the ... menu is not working on iOS atm
